...
workflow NFCORE_CREATEPANELREFS {
    ...
    CREATEPANELREFS(samplesheet, tools, gcnv_model_name, gens_pon_analysis_type, gens_pon_name, mutect2_pon_name, fasta, dict, fai, cnvkit_targets, gcnv_exclude_bed, gcnv_exclude_interval_list, gcnv_mappable_regions, gcnv_ploidy_priors, gcnv_segmental_duplications, gcnv_target_bed, gcnv_target_interval_list, gens_interval_list, mutect2_target_bed)
